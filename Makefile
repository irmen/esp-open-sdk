...
VENDOR_SDK_ZIP_3.0.2 = ESP8266_NONOS_SDK-3.0.2.zip
...
.sdk_patch_3.0.2: user_rf_cal_sector_set.o
...
ESP8266_NONOS_SDK-3.0.2.zip:
	wget --content-disposition "https://github.com/espressif/ESP8266_NONOS_SDK/archive/v3.0.2.zip"
